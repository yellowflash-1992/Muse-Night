      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
              className:
                "font-display text-3xl sm:text-5xl font-medium tracking-tight text-paper text-balance leading-tight",
              children: musing.title,
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "flex items-center justify-between pt-2 text-xs uppercase tracking-[0.18em] text-paper-faint",
              children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "my-8 p-6 rounded-lg bg-ink-2 border-l-2 border-neon text-lg sm:text-xl font-display text-paper italic leading-relaxed",
          children: ["“", musing.excerpt, "”"],
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("article", {
          className:
            "prose prose-invert max-w-none text-base sm:text-lg leading-[1.85] text-paper/90 space-y-6",
          children: musing.content.map((paragraph, index) =>
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "mt-16 pt-8 border-t border-neon/15 bg-ink-2 p-6 rounded-lg flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
              to: "/about",
              className:
                "rounded border border-neon/30 px-4 py-2 text-xs uppercase tracking-[0.18em] text-paper hover:bg-neon/10 transition-colors shrink-0",
              children: "Author Bio →",
            }),
          ],
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "mt-12 flex justify-between items-center text-xs uppercase tracking-[0.2em] text-paper-dim",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
              to: "/musings",
