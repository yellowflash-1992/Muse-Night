  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
              to: "/books",
              className:
                "inline-flex items-center gap-2 text-xs uppercase tracking-[0.22em] text-paper-dim hover:text-neon transition-colors",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, {
                  className: "h-3.5 w-3.5",
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "All Chapbooks" }),
              ],
            }),
          }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className:
                    "overflow-hidden rounded-xl bg-ink-3 aspect-[4/5] shadow-2xl border border-neon/20 lg:sticky lg:top-28",
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className:
                          "flex items-center gap-2 text-xs uppercase tracking-[0.28em] text-neon/80 mb-2",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookMarked, {
                            className: "h-3.5 w-3.5",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            children: "Letterpress Chapbook Edition",
                          }),
                        ],
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                        className:
                          "text-xs uppercase tracking-[0.2em] text-neon flex items-center gap-1.5",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, {
                            className: "h-4 w-4",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            children: "In Stock · Ready for dispatch",
                          }),
                        ],
                      }),
                    ],
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "p-5 rounded-lg bg-ink-2 border-l-2 border-neon text-paper italic font-display text-xl leading-relaxed",
                    children: ["“", book.quote, "”"],
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
                        className:
                          "text-xs uppercase tracking-[0.25em] text-neon/90 font-medium border-b border-neon/10 pb-2",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
                        ...
                        children: book.tableOfContents.map((item, index) =>
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                        ...
                        className:
                          "inline-flex items-center justify-center gap-2 rounded bg-neon px-6 py-3.5 text-xs uppercase tracking-[0.22em] font-medium text-ink hover:bg-neon/90 transition-all shadow-md",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Package, {
                            className: "h-4 w-4",
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            children: "Reserve Hand-Numbered Copy",
                          }),
                        ],
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                        to: "/poems",
                        className:
                          "inline-flex items-center justify-center gap-2 rounded border border-neon/30 px-5 py-3 text-xs uppercase tracking-[0.2em] font-medium text-paper hover:bg-neon/10 transition-all",
                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          children: "Read Digital Verses",
                        }),
                      }),
                    ],
                  }),
      ...
      orderModalOpen &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          className:
            "fixed inset-0 z-50 flex items-center justify-center bg-ink/80 backdrop-blur-sm p-4 animate-in fade-in",
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "w-full max-w-lg rounded-xl border border-neon/30 bg-ink-2 p-6 sm:p-8 shadow-2xl relative overflow-y-auto max-h-[90vh]",
            children: [
                ...
                ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                        ...
                        className:
                          "mt-4 rounded bg-neon px-6 py-2.5 text-xs uppercase tracking-[0.2em] font-medium text-ink",
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            className:
                              "flex items-center gap-2 text-xs uppercase tracking-[0.25em] text-neon/80 mb-1",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, {
                                className: "h-3.5 w-3.5",
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                children: "Reserve Edition",
                              }),
                            ],
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
                            className: "font-display text-2xl text-paper",
                            children: ["Order ", book.title, " — ", book.price],
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                            type: "submit",
                            className:
                              "inline-flex items-center gap-2 rounded bg-neon px-5 py-2.5 text-xs uppercase tracking-[0.2em] font-medium text-ink hover:bg-neon/90",
                            children: [
