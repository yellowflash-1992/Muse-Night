          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                children: "Return to Collections",
              }),
            ],
          }),
        }),
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "All Collections" }),
            ],
          }),
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-start border-b border-neon/10 pb-12",
          children: [
            collection.coverImage &&
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className:
                    "overflow-hidden rounded-lg bg-ink-3 aspect-[4/5] shadow-2xl border border-neon/20",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "flex items-center gap-2 text-xs uppercase tracking-[0.28em] text-neon/80",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Layers, {
                      className: "h-3.5 w-3.5",
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                      children: ["Volume Published ", collection.year],
                    }),
                  ],
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "flex items-center gap-2 text-xs uppercase tracking-[0.25em] text-neon/80 mb-3",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Quote, { className: "h-3.5 w-3.5" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                  children: "Author's Foreword",
                }),
              ],
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
              className: "font-display text-xl sm:text-2xl text-paper leading-relaxed italic",
              children: ["“", collection.foreword, "”"],
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              ...
              children: includedPoems.map((poem, idx) =>
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "div",
                  {
                    className:
                      "py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 group hover:bg-neon/5 px-3 rounded transition-colors",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
                                className:
                                  "font-display text-2xl text-paper group-hover:text-neon transition-colors",
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                                ...
                                children: [poem.linesCount, " lines · ", poem.readTime, " read"],
                              }),
                            ],
                          }),
                        ],
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "pt-10 border-t border-neon/10 flex flex-col sm:flex-row items-center justify-between gap-4",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
              to: "/collections",
