...
import { C as BookOpen, d as Moon, g as Feather, h as FileText, i as Sparkles, m as Layers, n as Users, p as Mail, r as Sun, t as X, x as Check } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BwXs06av.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-BW0R87VK.css";
/**
...
function ThemeToggle({ className = "" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		type: "button",
		onClick: toggleTheme,
		"aria-label": theme === "dark" ? "Switch to Sunlit Florentine mode" : "Switch to Midnight Lamplight mode",
		title: theme === "dark" ? "Switch to Sunlit Florentine (Light Mode)" : "Switch to Midnight Lamplight (Dark Mode)",
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: theme === "dark" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Moon, { className: "h-4 w-4 text-neon transition-transform duration-300 group-hover:-rotate-12" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sun, { className: "h-4 w-4 text-amber-500 transition-transform duration-300 group-hover:rotate-45" })
...
function Navbar() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Vol. II — Winter 2024" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "A Small Press for Two Poets & Literary Works" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Est. Edinburgh & Stockholm" })
					]
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Feather, { className: "h-4 w-4" })
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
							...
							children: links.map((link) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									...
									children: [link.label, active && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute -bottom-1 left-0 right-0 h-[1.5px] bg-neon rounded-full" })]
								}, link.to);
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookOpen, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Read Poems" })]
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "block md:hidden fixed top-3 left-0 right-0 z-50 px-4 pointer-events-none",
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "flex items-center gap-3",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "h-4 w-4 text-neon" }), "Home Masthead"]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "flex items-center gap-3",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: `h-4 w-4 ${link.color}` }), link.label]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-xs text-paper-faint",
									children: link.count
								})]
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							subscribed ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "h-4 w-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "You're inscribed on our letter list." })]
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Muse Books — Hand-bound & Typeset · MMXXIV" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Cormorant & Spectral Typography" })]
			})]
		})
	});
}
...
var $$splitComponentImporter$6 = () => import("./routes-DMInXtPT.mjs");
...
var Route$5 = createFileRoute("/about")({
	head: () => ({ meta: [{ title: "About the Press & Poets — Muse Books" }, {
		name: "description",
...
var Route$4 = createFileRoute("/submit")({
	head: () => ({ meta: [{ title: "Submissions & Call for Poetry — Muse Books" }, {
		name: "description",
...
var Route$3 = createFileRoute("/books/")({
	head: () => ({ meta: [{ title: "Hand-Bound Chapbooks — Muse Books" }, {
		name: "description",
...
var Route$2 = createFileRoute("/collections/")({
	head: () => ({ meta: [{ title: "Poetry Collections — Muse Books" }, {
		name: "description",
...
var Route$1 = createFileRoute("/musings/")({
	head: () => ({ meta: [{ title: "Musings & Essays on Literature — Muse Books" }, {
		name: "description",
...
var Route = createFileRoute("/poems/")({
	head: () => ({ meta: [{ title: "Poems Library — Muse Books" }, {
		name: "description",
