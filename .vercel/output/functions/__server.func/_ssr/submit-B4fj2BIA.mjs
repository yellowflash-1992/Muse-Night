...
import { S as Calendar, b as CircleCheck, g as Feather, h as FileText, i as Sparkles, o as Send } from "../_libs/lucide-react.mjs";
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Feather, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Open Call for Writers & Poets" })]
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "We are always listening for voices that write with patience, attention to silence, and care for language. We accept standalone poems, chapbook suites, and craft musings."
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Calendar, { className: "h-4 w-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Reading Schedule" })]
								}),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: "We review submissions on a rolling basis. Expect a thoughtful personal response within 4 to 6 weeks."
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-neon",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, { className: "h-4 w-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Formats Accepted" })]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									className: "font-display text-xl text-paper",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs text-paper-dim leading-relaxed",
									children: "1–5 poems per submission, or a full chapbook manuscript of 20–35 pages. Musings: 800–2,000 words."
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-neon",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "h-4 w-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Letterpress Print" })]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									className: "font-display text-xl text-paper",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs text-paper-dim leading-relaxed",
									children: "Selected poems are published digitally and considered for our limited letterpress chapbook runs."
								})
							]
						})
					]
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											children: "•"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Poems that honor sensory detail, domestic solitude, weather, and memory." })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										className: "flex items-start gap-2",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-neon mt-0.5",
											children: "•"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Epistolary poems (letters, postcards, dispatches to absent companions)." })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										className: "flex items-start gap-2",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-neon mt-0.5",
											children: "•"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Essays reflecting on the physical craft of reading, typesetting, and writing." })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
										className: "flex items-start gap-2",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-neon mt-0.5",
											children: "•"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Translations of under-represented international poets." })]
									})
								]
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "rounded-xl border border-neon/10 bg-ink-2/60 p-6 text-xs text-paper-dim space-y-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-neon uppercase tracking-[0.2em] font-medium",
								children: "Author Rights"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "leading-relaxed",
								children: "Authors retain all copyrights to their original work. Muse Books requests first serial rights and non-exclusive archival rights."
							})]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "col-span-12 lg:col-span-7",
						children: submitted ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "rounded-xl border border-neon/40 bg-ink-2 p-8 sm:p-12 text-center space-y-6 animate-in fade-in",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "pt-4 border-t border-neon/10 flex flex-col sm:flex-row items-center justify-between gap-4",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-xs text-paper-faint text-center sm:text-left",
										children: "No reading fees. We never charge writers to read their work."
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Send, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Submit Work" })]
									})]
								})
							]
						})
