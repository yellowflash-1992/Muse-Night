        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
              ...
              children:
                "Essays on poetic craft, letterpress philosophy, and reflections written during the quiet intervals between poems.",
            }),
          ],
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          className: "mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8",
          children: MUSINGS.map((musing) =>
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "article",
              {
                className:
                  "group rounded-xl border border-neon/15 bg-ink-2 p-6 sm:p-8 flex flex-col justify-between hover:border-neon/40 hover:-translate-y-1 transition-all",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
                        className:
                          "font-display text-2xl sm:text-3xl font-medium text-paper leading-tight group-hover:text-neon transition-colors",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "mt-8 pt-5 border-t border-neon/10 flex items-center justify-between",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        className: "text-xs text-paper-faint",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                            children: ["By ", musing.author],
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
