			...
			children: [
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "inline-flex items-center gap-2 text-xs uppercase tracking-[0.28em] text-neon/80",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Feather, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Our Story & Ethos" })]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
									className: "font-display text-4xl sm:text-7xl font-medium text-paper text-balance leading-[0.95]",
							...
							className: "col-span-12 lg:col-span-4 text-sm text-paper-dim leading-relaxed lg:border-l lg:border-neon/15 lg:pl-8",
							children: "Muse Books was founded on a rainy winter night in Edinburgh in 2022. Frustrated by the disposable speed of contemporary digital media, we set out to build a quiet sanctuary for literature that takes its time."
						})]
					})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: Object.values(POETS).map((poet) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center justify-between text-xs uppercase tracking-[0.2em] text-neon/80",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: poet.role }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "flex items-center gap-1 text-paper-faint",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "h-3 w-3" }), poet.location]
									})]
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-xs uppercase tracking-[0.18em] text-paper-faint block mb-2",
									children: "Published Works at Muse:"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "flex flex-wrap gap-2",
									children: poet.works.map((w) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center gap-2 text-xs uppercase tracking-[0.25em] text-neon/80 mb-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Compass, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Craft & Method" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: "Every physical volume bearing the Muse imprint is handset in metal type and printed on our restored 1890s Albion hand press. We do not use commercial high-speed offset machinery."
							})
						]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
									...
									children: "Hand-set letter by letter in Monotype Bembo, Caslon Old Face, and Garamond."
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "space-y-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
									...
									className: "text-xs text-paper-dim leading-relaxed",
									children: "Acid-free, 100% cotton mould-made paper made with pure spring water in Bavaria and Somerset."
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "space-y-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
									...
									className: "text-xs text-paper-dim leading-relaxed",
									children: "Each signature is folded by hand and sewn with unbleached Irish linen thread or Japanese silk."
								})]
							})
						]
					})]
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "p-6 rounded-lg border border-neon/10 bg-ink-2 space-y-2 flex flex-col justify-between",
