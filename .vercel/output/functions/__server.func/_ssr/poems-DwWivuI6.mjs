...
import { C as BookOpen, T as ArrowRight, g as Feather, s as Search } from "../_libs/lucide-react.mjs";
...
function PoemsIndex() {
	...
	const filteredPoems = (0, import_react.useMemo)(() => {
		return POEMS.filter((poem) => {
			const matchSearch = search === "" || poem.title.toLowerCase().includes(search.toLowerCase()) || poem.author.toLowerCase().includes(search.toLowerCase()) || poem.stanzas.some((s) => s.some((l) => l.toLowerCase().includes(search.toLowerCase())));
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Feather, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "The Verse Library" })]
						}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-paper-faint" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								type: "text",
								value: search,
							...
							}), Object.values(POETS).map((poet) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
						...
						children: [
							...
							allTags.map((tag) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								type: "button",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-10",
					children: filteredPoems.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "text-center py-20 rounded-lg border border-dashed border-neon/20 bg-ink-2/40",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookOpen, { className: "mx-auto h-8 w-8 text-paper-faint mb-3" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: filteredPoems.map((poem) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: poem.readTime })]
								}),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [poem.stanzas[0]?.slice(0, 3).map((line, lIdx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "truncate",
										children: line
									}, lIdx)), (poem.stanzas[0]?.length ?? 0) > 3 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: poem.tags.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Read Poem" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "h-3 w-3" })]
								})]
							})]
						}, poem.id))
					})
