			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Layers, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Anthologies & Suites" })]
					}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Cohesive volumes of verse curated around distinct seasons, geographies, and spiritual atmospheres."
					})
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-12 space-y-12",
				children: COLLECTIONS.map((collection, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
					...
					children: [collection.coverImage && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "overflow-hidden rounded-lg bg-ink aspect-[4/5] shadow-lg group",
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex flex-wrap items-center gap-3 text-xs uppercase tracking-[0.22em] text-paper-faint",
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: collection.year }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "·" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [collection.poemsCount, " Works"] })
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								className: "font-display text-3xl sm:text-4xl font-medium text-paper hover:text-neon transition-colors",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									to: "/collections/$id",
									params: { id: collection.id },
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "p-4 rounded-md bg-ink border-l-2 border-neon/40 text-xs sm:text-sm text-paper-dim italic",
								children: [
									"“",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "View Collection & Contents" }),
