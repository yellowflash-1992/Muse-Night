...
function PoemReader() {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
            to: "/poems",
            className:
              "inline-flex items-center gap-2 rounded bg-neon px-4 py-2 text-xs uppercase tracking-[0.2em] font-medium text-ink",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, { className: "h-4 w-4" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                children: "Return to Poems Library",
              }),
            ],
          }),
        }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                to: "/poems",
                className:
                  "inline-flex items-center gap-2 text-xs uppercase tracking-[0.22em] text-paper-dim hover:text-paper transition-colors",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, {
                    className: "h-3.5 w-3.5",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "All Poems" }),
                ],
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "flex items-center rounded-md border border-neon/20 bg-ink-2 p-0.5 text-xs",
                    children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                    ...
                    onClick: handleCopy,
                    className:
                      "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md border border-neon/20 bg-ink-2 text-xs uppercase tracking-[0.18em] text-paper-dim hover:text-neon transition-colors",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "inline-flex items-center gap-2 text-[10px] sm:text-xs uppercase tracking-[0.25em] sm:tracking-[0.3em] text-neon/90 font-medium",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                    children: poem.collection,
                  }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
                className:
                  "font-display text-3xl sm:text-5xl lg:text-6xl font-medium tracking-tight text-paper text-balance leading-tight",
                children: poem.title,
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className: "pt-1",
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                  to: "/about",
                  className:
                    "text-xs uppercase tracking-[0.22em] text-paper-dim hover:text-neon transition-colors",
                  children: ["By ", poem.author],
                }),
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "flex justify-center items-center gap-3 pt-2 text-[10px] sm:text-xs uppercase tracking-[0.2em] text-paper-faint",
                children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                ...
                children: poem.stanzas.map((stanza, sIdx) =>
              ...
              poem.note &&
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "mt-12 sm:mt-16 pt-6 border-t border-neon/15 text-xs sm:text-sm text-paper-dim italic bg-ink-2/60 p-4 sm:p-5 rounded-lg border border-neon/10",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                      className:
                        "text-[10px] sm:text-xs uppercase tracking-[0.2em] text-neon not-italic font-medium mb-1.5",
                ...
                children: poem.tags.map((t) =>
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    Link,
                    {
                      to: "/poems",
                      className:
                        "text-[11px] uppercase tracking-[0.16em] text-paper-faint hover:text-neon bg-ink-2 border border-neon/15 px-2.5 py-1 rounded-full transition-colors",
                      children: ["#", t],
                    },
                    t,
                  ),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
            className:
              "mt-12 sm:mt-16 pt-8 border-t border-neon/15 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6",
            children: [
              prevPoem
                ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                    to: "/poems/$id",
                    ...
                    className:
                      "group p-4 sm:p-5 rounded-xl border border-neon/15 bg-ink-2 hover:border-neon/40 active:scale-[0.98] transition-all flex flex-col items-start",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                        className:
                          "text-[10px] uppercase tracking-[0.22em] text-paper-faint flex items-center gap-1.5 mb-1",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                        className:
                          "font-display text-lg sm:text-xl text-paper group-hover:text-neon transition-colors",
              ...
              nextPoem
                ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                    ...
                    className:
                      "group p-4 sm:p-5 rounded-xl border border-neon/15 bg-ink-2 hover:border-neon/40 active:scale-[0.98] transition-all flex flex-col items-end text-right",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                        className:
                          "text-[10px] uppercase tracking-[0.22em] text-paper-faint flex items-center gap-1.5 mb-1",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "sm:hidden fixed bottom-4 left-4 right-4 z-40 bg-ink-2/95 backdrop-blur-md border border-neon/30 rounded-full px-4 py-2.5 shadow-2xl flex items-center justify-between",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                ...
                className:
                  "px-2.5 py-1 rounded-full bg-ink border border-neon/20 text-xs font-serif text-paper",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
            ...
            onClick: handleCopy,
            className:
              "inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-neon text-ink text-xs font-medium uppercase tracking-[0.15em]",
            children: [
              copied
