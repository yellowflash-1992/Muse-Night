      ...
      if (
        ((this.init = (t) => {
          ...
          ((this.parentRoute = this.options.getParentRoute?.()),
            r ? (this._path = p) : this.parentRoute || e());
          let i = r ? p : n?.path;
          i && i !== `/` && (i = d(i));
          let a = n?.id || i,
            s = r ? p : o([this.parentRoute.id === `__root__` ? `` : this.parentRoute.id, a]);
          (i === `__root__` && (i = `/`), s !== `__root__` && (s = o([`/`, s])));
          let c = s === `__root__` ? `/` : o([this.parentRoute.fullPath, i]);
          ((this._path = i), (this._id = s), (this._fullPath = c), (this._to = f(c)));
        }),
        ...
        (this.redirect = (e) => m({ from: this.fullPath, ...e })),
        (this.options = t || {}),
...
function C(e, n) {
  ...
  return (i) => {
    ...
    return (e?.structuralSharing ?? n.options.defaultStructuralSharing)
      ? (r.current = t(r.current, a))
      : a;
  };
}
function w(t) {
  let n = s(),
    r = y.useContext(t.from ? x : b),
    i = t.from ? n.stores.getRouteMatchStore(t.from) : n.stores.matchStores.get(r),
    a = C(t, n),
    o = u(i ?? S, (e) => (e ? a(e) : S));
  if (o !== S) return o;
  (t.shouldThrow ?? !0) && e();
...
function A(e) {
  return w({ ...e, select: (t) => (e.select ? e.select(t.context) : t.context) });
}
var j = a(),
  M = class extends _ {
    constructor(e) {
      (super(e),
        (this.useMatch = (e) =>
          w({ select: e?.select, from: this.id, structuralSharing: e?.structuralSharing })),
        (this.useRouteContext = (e) => A({ ...e, from: this.id })),
        (this.useSearch = (e) =>
          O({ select: e?.select, structuralSharing: e?.structuralSharing, from: this.id })),
        (this.useParams = (e) =>
          D({ select: e?.select, structuralSharing: e?.structuralSharing, from: this.id })),
        (this.useLoaderDeps = (e) => E({ ...e, from: this.id })),
        (this.useLoaderData = (e) => T({ ...e, from: this.id })),
        (this.useNavigate = () => k({ from: this.fullPath })),
        (this.Link = y.forwardRef((e, t) => (0, j.jsx)(l, { ref: t, from: this.fullPath, ...e }))));
    }
  };
function N(e) {
  return new M(e);
...
var B = `modulepreload`,
  ...
  U = function (e, t, n) {
    ...
    if (t && t.length > 0) {
      ...
      r = o(
        t.map((t) => {
          if (((t = V(t, n)), (t = s(t)), t in H)) return;
          H[t] = !0;
...
export { C as a, g as c, P as i, m as l, z as n, b as o, L as r, h as s, U as t, p as u };
