      ...
      <div className="mx-auto max-w-md space-y-12">
        ...
        <div>
            ...
            {(["a", "b"] as const).map((side) => (
              ...
              >
                ...
                <div className="mt-2 flex items-center justify-between">
                  ...
                  {voted && (
                    <span className="text-xs text-neon">{side === voted ? "your pick" : ""}</span>
                  )}
                </div>
              </button>
            ))}
          ...
          {voted && (
            <p className="mt-3 text-xs text-paper-faint">
              Tap the other one anytime to change your vote — final pick counts when battle closes
              tonight.
            </p>
          )}
        </div>
        ...
        <div>
          ...
          <p className="mb-4 text-xs text-paper-dim">
            Today&apos;s prompt: <span className="text-paper">"what grief doesn't say"</span>
          </p>
